$(function () {
    ...
    $select.click(function () {
        ...
        $.get("/RoomReserves/GetRoomByDateTime", { "SDay": $("#SDay").val(), "SMonth": $("#SMonth").val(), "SYear": $("#SYear").val(), "SHour": $("#SHour").val(), "SMin": $("#SMin").val(), "EDay": $("#EDay").val(), "EMonth": $("#EMonth").val(), "EYear": $("#EYear").val(), "EHour": $("#EHour").val(), "EMin": $("#EMin").val() }, function (rs) {
            setTimeout(function () {
                $("#Reports").html(rs);
                InitDatatable();
            }, 300)
